...
<body>
	<br>
	<h1 align="center">
		<font size="5" style="background-color: buttonface;">Delete from app_spanish recipes table</font><br>
	</h1>
	<center>
		<table width="300">
			<tr>
		...
		<br> <input type="submit" id="deleteSpanishRecipe" value="DELETE"
			style="height: 25px; width: 80px; font-size: 15px;"> <input
			type="submit" id="viewAppSpanishRecipesTable" value="VIEW TABLE"
			style="height: 25px; width: 100px; font-size: 15px;">
		<h1 align="center">
			<font size="5" style="background-color: buttonface;">Delete from app_spanish_recipes_trans table</font><br>
		</h1>
		<table width="350">
			<tr>
				<td style="background-color: buttonface;">Translated Spanish Recipe ID:</td>
		...
		<h1 align="center">
			<font size="5" style="background-color: buttonface;">Delete from app_spanish_recipes_ingredients
				table</font><br>
		</h1>
		<table width="300">
			<tr>
				<td style="background-color: buttonface;">Spanish Ingredient ID:</td>
		...
		<input type="submit" id="viewAppSpanishRecipesIngredientsTable"
			...
			style="height: 25px; width: 100px; font-size: 15px;"> <br>
		<h1 align="center">
			<font size="5" style="background-color: buttonface;">Delete from app_spanish_recipes_description
				table</font><br>
		</h1>
		<table width="350">
			<tr>
				<td style="background-color: buttonface;">Spanish Recipe Description ID:</td>
